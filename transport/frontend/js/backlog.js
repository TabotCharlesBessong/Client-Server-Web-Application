...
let pasData = [
    {pasID: 666, name: "Tabot Charles", idNum: 000140105, origin: "Kuwait", destination: "Dakar", busNum: "E205"},
    {pasID: 666, name: "Tabot Charles", idNum: 000140105, origin: "Kuwait", destination: "Dakar", busNum: "E205"},
    {pasID: 666, name: "Tabot Charles", idNum: 000140105, origin: "Kuwait", destination: "Dakar", busNum: "E205"},
    {pasID: 666, name: "Tabot Charles", idNum: 000140105, origin: "Kuwait", destination: "Dakar", busNum: "E205"},
    {pasID: 666, name: "Tabot Charles", idNum: 000140105, origin: "Kuwait", destination: "Dakar", busNum: "E205"},
...
const populatePassengerTable = () => {
    ...
    let th1 = rowHeader.insertCell();
    th1.textContent = "Pas ID"
    let th2 = rowHeader.insertCell();
    th2.textContent = "Name"
    let th3 = rowHeader.insertCell();
    th3.textContent = "ID Number"
    ...
    for(let passenger of pasData){
        ...
        cellOne.textContent = passenger.pasID
        cellTwo.textContent = passenger.name
        cellThree.textContent = passenger.idNum
        cellFour.textContent = passenger.origin
        cellFive.textContent = passenger.destination
        cellSix.textContent = passenger.busNum
    }
    pasTable.append(pas);
}
